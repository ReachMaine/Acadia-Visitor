...
function ale_enqueue_scripts() {
	...
	// zig xout wp_register_script( 'html5-shim', 'http://html5shim.googlecode.com/svn/trunk/html5.js', array( 'jquery' ), ALETHEME_THEME_VERSION, false );
	// add modernizr
...
// zig xout	wp_enqueue_script( 'html5-shim' );
