<?php /* 
    5may15 zig - remove comments from bottom of post item
*/ ?>
...
<div class="itemboxwhite">
    ...
    <div class="bottomblogitem cf">
        <div class="leftdatablog">
           <?php /*  <?php echo get_comments_number(); ?> <?php _e('comments', 'aletheme')?> / <?php if(get_post_meta($post->ID, "votes_count", true)==""){ echo "0";} else { echo get_post_meta($post->ID, "votes_count", true);};?> <?php _e('votes', 'aletheme')?> */ ?>
        </div>
